...
const DANFe = async (data: { xml?: string, consulta?: string, logo?: any | null, imgDemo?: string | null } = {}) => {
    ...
    async function bloco0(page = PDF.pages[(PDF.pages.length - 1)]) {
        // Em homologacao (tpAmb = 2) o nome do destinatario e substituido pelo texto
        // obrigatorio da SEFAZ; em producao (tpAmb = 1) exibe o destinatario real.
        // Comparacao frouxa proposital: o parser pode devolver string ou number.
        const nomeDestinatario = xml.NFe.infNFe.ide.tpAmb == 2

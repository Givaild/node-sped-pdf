...
var DANFe = async (data = {}) => {
  ...
  async function bloco0(page = PDF.pages[PDF.pages.length - 1]) {
    const nomeDestinatario = xml.NFe.infNFe.ide.tpAmb == 2 ? "NF-E EMITIDA EM AMBIENTE DE HOMOLOGACAO - SEM VALOR FISCAL" : xml.NFe.infNFe.dest?.xNome || "";
  ...
  async function bloco6(page = PDF.pages[PDF.pages.length - 1]) {
    ...
    addTXT({ page, text: "B.C\xC1LC ICMS", ...celula(10), y: PDF.mtBlock + 8.5, align: "center" });
    ...
    addTXT({ page, text: "AL\xCDQ. ICMS", ...celula(13), y: PDF.mtBlock + 8.5, align: "center" });
    addTXT({ page, text: "AL\xCDQ. IPI", ...celula(14), y: PDF.mtBlock + 8.5, align: "center" });
